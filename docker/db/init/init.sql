-- ============================================================
-- MacroCook - Full Database Schema
-- Po zmianie tego pliku: docker compose down -v && docker compose up -d --build
-- ============================================================
...
INSERT INTO cooking_steps (recipe_id, step_number, title, instructions, duration_minutes) VALUES
    ...
    (1, 3, 'Grill the salmon', 'Place salmon skin-side down on a preheated grill (medium-high). Cook for 4-5 minutes per side until internal temp reaches 145°F.', 10),
...
INSERT INTO cooking_steps (recipe_id, step_number, title, instructions, duration_minutes) VALUES
    ...
    (6, 2, 'Roast vegetables', 'Spread on a baking sheet. Roast at 200°C for 20 minutes.', 20),
...
INSERT INTO cooking_steps (recipe_id, step_number, title, instructions, duration_minutes) VALUES
    (8, 1, 'Sauté aromatics', 'Dice onion, carrots, celery. Sauté in olive oil over medium heat 5 minutes.', 5),
...
-- ============================================================
-- RECIPE TAGS (connect recipes to tags)
-- ============================================================
...
-- ============================================================
-- DAILY TRACKING (Alex's data for today-ish)
-- ============================================================
